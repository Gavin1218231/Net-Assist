...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] flex flex-col items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] hover:bg-[var(--color-bg-secondary)] transition-colors font-medium text-[var(--color-text)] mb-6"
        >
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-sm text-[var(--color-text-muted)]">or sign up with email</span>
          <div className="flex-1 h-px bg-[var(--color-border)]" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start gap-2">
            <input type="checkbox" className="rounded border-[var(--color-border)] mt-1" required />
            <span className="text-sm text-[var(--color-text-secondary)]">
              I agree to the{' '}
              <button type="button" className="text-[var(--color-primary)] hover:underline">Terms of Service</button>
              {' '}and{' '}
              <button type="button" className="text-[var(--color-primary)] hover:underline">Privacy Policy</button>
            </span>
          </div>
